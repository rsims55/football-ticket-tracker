...
- Model last trained: **2026-03-30 06:47:18**
...
- **daily_snapshot**: **success** (_2026-03-30 05:41:13_) — Snapshot appended (3183 new rows). Total now: 52546
- **model_train**: **success** (_2026-03-30 06:47:18_) — CatBoost training complete for 2026
- **weekly_report**: **success** (_2026-03-29 08:15:08_) — Weekly report generated: reports\weekly\2026-03-29\weekly_report_2026-03-29.md
- **health_check**: **success** (_2026-03-07 19:21:04_) — Health check passed

## 🗓️ Season State & Data Freshness

- Season state: **Offseason**
- Snapshots last updated: **2026-03-30 05:41:13**
- Model last trained: **2026-03-30 06:47:18**
...
- homeTeam: 21.5158 (~21.5%)
- hours_until_game: 11.5177 (~11.5%)
- capacity: 10.6053 (~10.6%)
- kickoff_hour: 8.6138 (~8.6%)
- home_last_point_diff_at_snapshot: 8.1284 (~8.1%)
- awayTeam: 7.5907 (~7.6%)
- week: 7.5824 (~7.6%)
- away_last_point_diff_at_snapshot: 6.0304 (~6.0%)
- awayConference: 5.4769 (~5.5%)
- home_losses_at_snapshot: 3.6072 (~3.6%)
- homeConference: 2.9737 (~3.0%)
- away_wins_at_snapshot: 2.2844 (~2.3%)
- away_losses_at_snapshot: 2.0530 (~2.1%)
- away_losses_at_snapshot_missing: 0.6029 (~0.6%)
- homeTeamRank: 0.5301 (~0.5%)
- away_last_point_diff_at_snapshot_missing: 0.2800 (~0.3%)
- home_wins_at_snapshot_missing: 0.2729 (~0.3%)
- home_losses_at_snapshot_missing: 0.2305 (~0.2%)
- neutralSite: 0.1040 (~0.1%)
